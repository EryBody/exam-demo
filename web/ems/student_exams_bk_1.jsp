                ...
                <div id="content">
                    ...
                    <div class="container">
                        ...
                        <div>
                            ...
                            <span id="remainingTime" style="position: fixed;top:85px;left: 250px;font-size: 23px;background: rgba(255,0,77,0.38);border-radius: 5px;padding: 10px;box-shadow: 2px -2px 6px 0px;">02:40</span>
                        </div>
                                ...
                                <div class="card o-hidden border-0 shadow-lg my-5">
                                    <div class="card-body p-0">
                                        ...
                                        <div class="m-3 p-3 col-md-12">
                                            ...
                                            <a class="bodr border questionClicked" id="qc" href="#"><%=pageCounter%></a>  
                                            <%
                                                    pageCounter++;
                                                }
                                            %>
...
//                alert('Me');
                        var action_url = "jp.do?action=loan-param3-action";
                        var x = $(this).attr("id");
//                alert(x);
                        $.ajax({
                            url: action_url,
...
//                            console.log(data);
                                ...
                                //$('.buttonClick').attr("data-dispute", data.accountClassId);
                                $('.textType').html(data.loanTypeId);
                                $('.textAmountRange').html(data.amountRange);
                                $('.textTenor').html(data.tenure);
                                $('.textInterest').html(data.interestRate);
                                $('.textGracePeriod').html(data.gracePeriod);
                                $('.textRepayInst').html(data.repaymentInstrument);
                                $('.textDefaultRate').html(data.defaultRate);
                                $('.textRequirement').html(data.requirements);
                                $('.textCollateral').html(data.collateral);
                                $('.textManage').html(data.managementFee);
                                $('.textInsurance').html(data.insuranceFee);
                                $('.textEntryDate').html(data.entryDate);
                            },
