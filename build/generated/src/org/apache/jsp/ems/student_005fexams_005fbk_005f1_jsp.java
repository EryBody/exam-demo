...
public final class student_005fexams_005fbk_005f1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        ");
            ...
            String cName = "CIT104-Introduction to Computer";
...
//            String spageid = request.getParameter("page");
      ...
      out.write("</p>\n");
      out.write("                            <span id=\"remainingTime\" style=\"position: fixed;top:85px;left: 250px;font-size: 23px;background: rgba(255,0,77,0.38);border-radius: 5px;padding: 10px;box-shadow: 2px -2px 6px 0px;\">02:40</span>\n");
      out.write("                        </div>\n");
      out.write("\n");
      ...
      out.print(pageCounter);
      out.write("</a>-->  \n");
      out.write("                                            <a class=\"bodr border questionClicked\" id=\"qc\" href=\"#\">");
      out.print(pageCounter);
      out.write("</a>  \n");
      out.write("                                            ");
      ...
      out.write("//                alert('Me');\n");
      out.write("                        var action_url = \"jp.do?action=loan-param3-action\";\n");
      out.write("                        var x = $(this).attr(\"id\");\n");
      out.write("//                alert(x);\n");
      out.write("                        $.ajax({\n");
      out.write("                            url: action_url,\n");
      out.write("                            type: 'post',\n");
      ...
      out.write("\n");
      out.write("                                //$('.buttonClick').attr(\"data-dispute\", data.accountClassId);\n");
      out.write("                                $('.textType').html(data.loanTypeId);\n");
      out.write("                                $('.textAmountRange').html(data.amountRange);\n");
      out.write("                                $('.textTenor').html(data.tenure);\n");
      out.write("                                $('.textInterest').html(data.interestRate);\n");
      out.write("                                $('.textGracePeriod').html(data.gracePeriod);\n");
      out.write("                                $('.textRepayInst').html(data.repaymentInstrument);\n");
      out.write("                                $('.textDefaultRate').html(data.defaultRate);\n");
      out.write("                                $('.textRequirement').html(data.requirements);\n");
      out.write("                                $('.textCollateral').html(data.collateral);\n");
      out.write("                                $('.textManage').html(data.managementFee);\n");
      out.write("                                $('.textInsurance').html(data.insuranceFee);\n");
      out.write("                                $('.textEntryDate').html(data.entryDate);\n");
      out.write("                            },\n");
      ...
      out.write("             <script>\n");
      out.write("                $(document).ready(function () {\n");
      out.write("                    $('.questionClicked').click(function () {\n");
      out.write("//                \n");
      out.write("//                        var action_url = \"jp.do?action=loan-param3-action\";\n");
      out.write("                        var x = $(this).attr(\"qc\");\n");
      out.write("                        alert(x);\n");
      out.write("//                        $.ajax({\n");
      out.write("//                            url: action_url,\n");
      out.write("//                            type: 'post',\n");
