                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-md-12">
                            <div class="text-center">
                                ...
                                <p class="lead text-gray-800 mb-5">Login Error!!!</p>
                                <p class="text-gray-500 mb-0">Please Wait While Administrator Approves Your Registration!!!</p>
                                <a href="jp.do?action=login">&larr; Back to Login</a>
                            </div>
                        </div>
                    </div>
